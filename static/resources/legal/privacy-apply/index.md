...
[IR목적상 수집 및 처리되는 개인정보]

| 수집단계            | 수집/이용 목적                 | 수집항목                       | 보유 및 이용기간                                                      |
|---------------------|-------------------------------|-------------------------------|----------------------------------------------------------------|
| 주주 인적사항 등록  | 주주명부 기재                 | 이름, 주소, 주민등록번호, 연락처, 이메일 | 목적 달성시까지 (*주민등록번호는 법인세법에 의거하여 수집하고 있으며, 보관 시 암호화하여 저장하고 있습니다.) |
| 정보 수정           | 본인확인 및 주주명부 내 주소 변경 | 이름, 생년월일, 주소           | 상동                                                             |
| 명의개서            | 본인확인 및 주주명부 기재     | 이름, 주소, 주민등록번호, 연락처, 입금확인증 | 상동                                                             |


### 개인정보 처리 목적

- 채용 프로세스의 진행, 입사 지원자와의 커뮤니케이션, 합격여부 확인, 임직원 급여 및 대외 수당 지급을 위해 활용
- 주주명부 기재, 본인확인 및 주주명부 내 주소 변경, 주주명부 기재를 위한 목적
...
- 개인정보처리방침 버전번호 : 1.7
- 변경 내용 : IR목적상 수집 및 처리되는 개인정보 항목 추가
- 변경 개인정보처리방침 시행일자 : 2024년 06월 27일
