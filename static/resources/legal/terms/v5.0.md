...
본 약관은 리디 주식회사(이하 "회사"라 합니다)가 운영하는 웹사이트([www.ridi.com](http://www.ridi.com)), 앱마켓 앱, 기타 향후 개발되는 콘텐츠 등 정보 접근의 도구로 사용되는 여하한 모든 형태(이하 "플랫폼"이라 합니다)를 통하여 제공하는 상품 및 디지털콘텐츠 서비스(이하 "서비스"라 합니다)의 이용과 관련하여 이용자의 권리, 의무 및 책임사항 등을 규정함을 목적으로 합니다.
...
11. "쿠폰"이라 함은 회사가 회원에게 무상으로 발행하는 것으로서, 명시된 금액 또는 비율만큼  할인받거나 특정 콘텐츠를 이용할 수 있는 수단으로서 사이버머니를 제외한 것을 말합니다.
12. "상품권"이라 함은 회사가 직접 회원에게 발행하거나 제휴사를 통해 회원이 유상으로 구매하여 사이버머니 충전, 정액제 상품 구매 또는 콘텐츠 교환 등 유상으로 제공되는 회사의 서비스 구매에 사용할 수 있는 일체의 수단(모바일 상품권, 교환 코드 등 명칭 불문)으로서 사이버머니 그 자체를 제외한 것을 말합니다.
13. "구매확정"이라 함은 (i) 회원이 특정 이벤트 참여 목적상 구매행위를 자발적으로 표시하는 행위(이 경우 구매확정된 콘텐츠는 해당 이벤트 참여 목적에 한해 다운로드된 것과 동일하게 간주될 수 있습니다), 또는 (ii) 상품의 경우 회원이 배송받은 상품의 거래를 확정하는 의사표시를 말합니다.
14. "상품"이란 회사 또는 판매자가 플랫폼을 통하여 판매하는 유형의 재화 및 이와 관련된 용역을 말하며, 디지털 형태의 "콘텐츠"와 구별됩니다. 다만 "정액제 상품"·"상품권" 등 이 약관에서 별도로 정의된 용어는 그 정의에 따릅니다.
15. "판매자"란 회사와 입점·판매 계약을 체결하고 플랫폼을 통하여 자신의 상품을 판매하는 자를 말합니다.
16. 전항 각 호에 해당하는 정의 이외의, 기타 용어의 정의에 대하여는 거래 관행 및 관계 법령에 따릅니다.
...
1. 회사는 회원에게 알려야 할 사항이 발생하는 경우, 앱 푸시 발송, 알림(웹/애플리케이션) 게재, 회원이 제공한 전자우편주소로의 메일 전송, 회원이 제공한 휴대전화번호로의 문자 메시지 또는 SNS(카카오톡 등), 전화 등의 방법으로 통지할 수 있습니다. 회원이 통지를 받을 전자우편 주소를 지정한 때에는 회사의 통지는 부가통신사업자 또는 수신인이 관리하는 메일서버 등에 도착하여 회원이 검색할 수 있는 상태에 이르렀을 때 도달된 것으로 보며, 회원이 전자우편을 개봉하였는지 여부, 회원의 PC에 전자우편이 전송되었는지 여부는 불문합니다.
...
3. 회사는 회원의 광고성 정보 수신 동의 여부와 관계없이, 회원의 권리 및 혜택 보호를 위하여 다음 각 호의 사항을 앱 푸시, SNS(카카오톡 알림톡 등), 문자 메시지 등의 수단으로 통지할 수 있습니다.
  1. 회원가입, 첫 구매, 등급 산정 등에 따른 혜택 부여 안내
  2. 포인트 또는 쿠폰의 지급, 유효기간 임박, 소멸 등에 관한 안내
  3. 이용권, 상품권 등의 구매, 등록, 유효기간 및 환불 등에 관한 안내
  4. 기타 회원이 반드시 인지하여야 할 거래 관련 정보 및 혜택 안내
4. 회원은 회사에 실제로 연락이 가능한 전자우편주소, 휴대전화번호 등의 정보를 제공하고 해당 정보들을 최신으로 유지하여야 하며, 회사의 통지를 확인하여야 합니다.
5. 회원이 전항의 의무를 소홀히 하여 발생한 불이익에 대해서는 보호받지 못합니다.

### 제5조의2 광고성 또는 맞춤형 정보의 제공

1. 회사는 서비스의 운영과 관련하여 광고성 정보를 제공할 수 있습니다.
2. 회사는 앱 푸시, 전자우편, SNS(카카오톡 등), 문자 메시지 등 전자적 수단을 통해 광고성 정보 및 회원 맞춤형 정보를 제공할 수 있으며, 이는 광고성 정보에 대한 사전 수신 동의가 있는 경우 등 법령상 허용된 경우에 한하여 제공됩니다.
...
3. 회사는 재화, 콘텐츠 또는 용역에 대하여 표시·광고의 공정화에 관한 법률 제3조 소정의 부당한 표시·광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할 책임을 집니다.
...
1. 회원은 회사에 언제든지 서비스 이용을 중단하고 탈퇴를 요청할 수 있으며 회사는 즉시 회원 탈퇴를 처리합니다. 다만, 진행 중인 상품 주문, 배송, 교환·반품, 환불 및 분쟁처리와 관계 법령상 보존의무가 있는 정보의 처리에는 영향을 미치지 않습니다.
...
### 제13조의2 통신판매중개자의 지위 및 책임

1. 회사가 직접 판매하지 아니하고 판매자의 상품 거래를 중개하는 경우, 회사는 통신판매중개자로서 통신판매의 당사자가 아닙니다. 이 경우 상품·재고·배송·교환·반품·상품 하자·고객응대 등 거래에 관한 책임은 판매자에게 있습니다. 다만 회사가 직접 수행하는 결제 및 그에 따른 대금 환급, 회사가 소비자 보호를 위하여 행하는 조치, 그 밖에 관계 법령에 따라 회사가 부담하는 책임은 그러하지 아니합니다.
2. 회사는 각 거래 화면에 회사가 통신판매중개자라는 사실과 판매자의 정보를 고지합니다.
3. 다만 회사가 판매자의 정보를 제공하지 아니하거나 거래에 직접 관여하는 등 관계 법령상 책임이 있는 경우에는 그에 따른 책임을 부담합니다.
4. 회사가 직접 판매하는 상품에 대하여는 회사가 통신판매업자로서 책임을 부담합니다.
...
회사에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각 호의 하나로 할 수 있습니다. 단, 회사에서 현재 서비스 중인 것에 한하며, 정액제 상품의 경우 특정 결제수단에 의한 지급은 제한될 수 있습니다. 또한 상품 등 일부 재화 또는 용역에 대해서는 회사 정책에 따라 특정 결제수단의 사용이 제한될 수 있습니다. 기업회원이 이용하는 정액제 상품 이용권의 이용요금 납부 등의 의무는 기업회원이 속한 기업 또는 단체가 부담합니다.

1. 계좌이체
2. 카드결제
3. 온라인무통장입금
4. 전자화폐에 의한 결제
5. 회사가 인정한 사이버머니(리디캐시, 리디포인트)에 의한 결제(사이버머니는 콘텐츠 구매에만 사용할 수 있으며, 상품의 구매에는 사용할 수 없습니다)
...
3. 제2항에 따라 구매 신청을 정정, 취소한 경우 회사는 지급받은 대금을 제22조 또는 제22조의2의 규정에 따라 환급합니다.
...
1. 회사는 다음 각 호에 해당하는 경우를 부정 이용행위로 봅니다.
  ...
  10. 기타 다음과 같은 행위 등을 반복하거나 반복적이지 않더라도 그 행위의 내용이 중대하여 회사의 건전한 운영을 해하거나 회사의 서비스 운영을 고의로 방해하는 것으로 회사가 인정하는 경우
    - 회사의 운영에 관련하여 허위 사실을 적시하거나 유포하여 회사의 명예를 실추시키거나 회사의 신뢰성을 해하는 경우
      ...
      - 회사가 허용하는 범위를 초과하는 과도한 접속으로 서비스의 안정성을 해치는 비정상적 트래픽 유발 행위
      - 회사가 명시적으로 허용하지 않은 매크로, 스크립트, 봇, 스크래핑 등 자동화된 수단을 이용하여 특정 행위를 반복하는 자동화 장치 사용 행위
      - 서비스의 보안 취약점을 인지하면서 이를 이용하여 비인가된 접근을 시도하거나 데이터를 무단 추출하는 등 보안 취약점 악용 행위
      - 단시간 내 과도한 열람∙다운로드, 기술적 보호조치 무력화 등 일반적인 이용 패턴을 벗어나 서비스 및 타 이용자에게 피해를 주는 비정상적 행위
      - 회사의 차단 조치 등을 회피하기 IP를 우회하거나 기기 식별 정보 등을 위∙변조하여 접속하는 우회적 기술 및 변조 행위
      - 기타 불법적이거나 부당한 행위
2. 회사는 전항에 따른 부정 이용자가 발견 되었을 경우, 다음 각 호에 따른 조치를 취할 수 있으며, 만일 동일한 부정 이용자가 다수의 ID를 사용하고 있는 것으로 판단되는 경우 해당 ID 전부에 대하여 다음 각 호에 따른 조치를 취할 수 있습니다. 회사는 이와 별개로 이용자의 계정에 비정상적인 접근이 의심될 시, 계정 보호를 위한 조치(예: 2차 인증 요구, 로그인 제한 등을 포함하나 이에 한하지 아니함)를 취할 수 있습니다. 이 경우 회사는 이용자가 등록한 연락처(이메일) 또는 서비스 내 공지사항을 통해 해당 조치의 사유 및 해제 방법을 지체 없이 안내하며, 이용자는 본인 확인 절차를 거쳐 해당 조치의 해제를 요청할 수 있습니다.
  1. 1차 발견 시 회사는 전자우편, 팝업 웹페이지 표시 등 제5조의 방법을 통하여 해당 위반 사실을 사전 경고합니다. 회사는 이와 같은 경고와 동시에 이용제한 ID로 등록되어 서비스 이용을 정지시킴과 동시에 부정이용을 통해 취득한 콘텐츠, 리디캐시, 리디포인트의 이용을 중지할 수 있으며, 이용자는 10일의 소명 기간 내에 부정 이용 사실을 소명할 수 있습니다. 회사는 실물 상품의 경우 회수 조치 또는 배상을 요구할 수 있습니다.
  2. 2차 발견 시 회사는 위반 내용을 제5조의 방법을 통하여 고지하고, 필요시 법적인 대응을 할 수 있습니다. 회사는 회원에게 30일간의 소명 기간을 부여하고, 회원이 소명 기간 내 정당한 사유를 제시하지 못할 경우 회원 등록을 말소시키고 구입한 콘텐츠의 사용권한을 강제 종료하거나, 상품 주문을 취소·배송보류·회수하고 부정취득한 혜택의 회수 또는 손해배상을 청구할 수 있습니다.
...
### 제22조 콘텐츠 및 사이버머니 등의 환불

1. 회원은 환불에 관하여 유, 무선의 방법을 통하여 회사에 의사를 표시하여야 하며, 회사는 환불요청을 접수하고 회원의 요청과 환불규정 확인 후 신속하게 환불 처리합니다.
2. 거래가 취소된 경우 이용자는 회사로부터 제공받은 재화 또는 용역을 반환하고, 회사는 이를 반환받은 날로부터 3영업일 이내에 결제와 동일한 방법으로 대금을 환급하거나 환급에 필요한 조치를 취합니다. 동일한 방법으로 환급이 불가능할 때에는 이용자가 원하는 방법으로 환급합니다. 상품의 청약철회·반품·교환 및 환불은 제22조의2에서 정한 바에 따릅니다.
...
회원이 자발적으로 구매확정을 한 후에도 위 각 항에 해당하지 않으면 환불이 가능합니다. 단, 구매확정을 통해 특정한 이벤트에 참여하고 해당 이벤트의 참여 결과 수령한 경제적 이익(리디포인트, 쿠폰 포함)이 존재하는 경우, 환불시 해당 이익을 환수하거나, 해당 이익 부분은 제외하고 남은 잔액이 환불됩니다.  
...
2. 국고보조금(문화누리카드 등)을 통해 사이버머니를 구매 후 7일이 경과되었거나 사용한 경우 환불이 불가능하며, 잔액에 대한 현금 환불 또한 불가능합니다.
  ...
  2. 플랫폼에 1년 이상 로그인하지 않아 휴면회원으로 전환된 경우
    ...
    - 회사가 별도 프로모션 정책 등에 따라 사이버머니를 기존 가격보다 할인하여 판매하는 경우, 프로모션 정책상 환불이 불가하거나 본 약관의 환불 정책과 다른 내용의 환불 정책이 적용될 수 있습니다.
...
- 회사는 과오금의 환불절차는 디지털 콘텐츠 이용자 보호지침에 따릅니다.
...
- 회원이 유료 또는 무료로 획득한 교환권 번호를 입력하여 정액제 이용 기간을 부여받은 경우(기업회원으로서 정액제 상품을 이용하는 경우를 포함함) 또는 정액제 상품의 결제를 한 후 프로모션에 따라 지급받은 리디포인트를 사용한 경우에는 환불을 요청할 수 없습니다.
...
### 제22조의2 상품의 청약철회·반품·교환 및 배송

1. 상품의 배송, 청약철회, 반품, 교환 및 환불은 「전자상거래 등에서의 소비자보호에 관한 법률」 등 관계 법령 및 그에 반하지 않는 범위에서 각 상품 상세페이지에 표시된 거래조건에 따릅니다.
2. 회원은 관계 법령에서 정한 기간 내에 상품의 청약철회, 교환 또는 반품을 요청할 수 있습니다. 단, 소비자에게 책임 있는 사유로 상품이 멸실·훼손된 경우, 소비자의 사용 또는 일부 소비로 상품 가치가 현저히 감소한 경우, 시간 경과로 재판매가 곤란할 정도로 상품 가치가 현저히 감소한 경우, 복제가 가능한 상품의 포장이 훼손된 경우, 주문제작 상품 등 관계 법령에서 정한 사유가 있는 경우에는 청약철회가 제한될 수 있습니다.
3. 제22조(환불)는 디지털 콘텐츠 및 사이버머니에 적용되며, 상품에는 본 조가 적용됩니다.
4. 통신판매중개 상품의 배송·청약철회·반품·교환·환불은 판매자가, 회사가 직접 판매하는 상품은 회사가 책임집니다.
...
3. 회원이 창작하여 플랫폼에 게재 또는 등록한 게시물에 대한 저작권은 회원에게 있으며 해당 게시물이 타인의 지적 재산권을 침해하여 발생하는 모든 책임은 회원 본인에 귀속됩니다. 단, 회사는 회원의 편의를 위하여 회원이 등록한 게시물을 인공지능 분야의 연구 개발 목적으로 활용할 수 있습니다. 회원이 이와 같은 활용을 거부하고자 하는 경우 등록한 게시물을 삭제하거나 기타 비공개 처리하여 공중이 더이상 해당 게시물에 접근하지 못하는 상태로 전환할 수 있으며, 회사는 그와 같이 비공개 처리된 게시물은 더이상 위와 같은 목적으로 활용하지 않습니다.
...
1. 리디캐시란 회원이 회사 또는 제3자 플랫폼을 통하여 유상으로 구매한 사이버머니로, 콘텐츠 구매 시 결제 수단으로 사용할 수 있습니다.
...
2. 회사는 회원의 서비스 이용, 유료 결제, 이벤트 참여, 프로모션 등 회사의 정책에 따라 회원에게 일정한 리디포인트를 부여할 수 있습니다.
3. 리디포인트는 전자책 선물 서비스를 제외한 콘텐츠 구매 시 사용 가능하며, 현금으로 환불되지 않습니다.
4. 리디포인트 유효기간은 회사정책에 의한 기준을 따르며 유효기간 이후에는 자동으로 소멸되며, 소멸된 포인트는 복구되지 않습니다.
5. 회원이 리디포인트를 부정한 방법으로 취득한 증거가 있을 때에는 회사가 사전 통보 후 리디포인트를 삭제할 수 있습니다. 이때 회원은 이에 대해서 이의신청을 할 수 있으며, 이의신청이 정당한 경우 복구 등 보호조치를 실행합니다. 다만 회원이 현행법 위반 및 고의 또한 중대한 과실로 회사에 손해를 입힌 경우에는 사전 통보 없이 이용 계약을 해지할 수 있습니다.
6. 리디포인트는 타인에게 양도할 수 없으며, 회원 탈퇴 시 소멸됩니다.
7. 상품 구매로 적립된 리디포인트는 해당 구매가 청약철회·취소된 경우 회수되며, 이미 사용한 경우 환급금에서 그 상당액이 공제될 수 있습니다.

### 제29조의2 쿠폰

1. 회사는 회원에게 무상으로 쿠폰을 발급할 수 있으며, 쿠폰의 사용 대상, 할인 혜택, 유효기간 등은 회사가 별도로 정하여 표시합니다.
2. 쿠폰은 현금으로 환급될 수 없으며, 유효기간이 만료되거나 회원 탈퇴 시 소멸됩니다.
3. 회원이 쿠폰을 사용하여 결제한 내용을 취소하는 경우, 취소 시점에 해당 쿠폰의 유효기간이 남아있는 경우에 한하여 쿠폰이 복구됩니다.
4. 쿠폰은 타인에게 양도할 수 없으며, 부정한 방법으로 쿠폰을 획득하거나 사용하는 경우 회사는 쿠폰 회수 및 이용 제한 조치를 취할 수 있습니다.

### 제29조의3 상품권

1. 회원이 유상으로 구매한 상품권의 발행, 사용, 환불 및 유효기간 등은 '신유형 상품권 표준약관' 등 관련 법령 및 해당 상품권의 판매 페이지에 명시된 별도 이용조건에 따릅니다.
2. 상품권은 리디캐시로 충전하거나 콘텐츠와 교환하여 사용할 수 있으며, 충전된 이후의 사용 및 환불에 대해서는 본 약관의 리디캐시 및 환불 규정을 준용합니다.
...
- 이용약관 버전번호 : 5.0
- 이용약관 변경 공고일자 : 2026년 7월 16일
- 변경 이용약관 시행일자 : 2026년 8월 20일

이전 이용약관 보기

- [리디 이용약관 (v4.14)](https://policy.ridi.com/legal/terms/v4.14)
- [리디 이용약관 (v4.13)](https://policy.ridi.com/legal/terms/v4.13)
- [리디 이용약관 (v4.12)](https://policy.ridi.com/legal/terms/v4.12)
- [리디 이용약관 (v4.11)](https://policy.ridi.com/legal/terms/v4.11)
- [리디 이용약관 (v4.10)](https://policy.ridi.com/legal/terms/v4.10)
- [리디 이용약관 (v4.9)](https://policy.ridi.com/legal/terms/v4.9)
- [리디 이용약관 (v4.8)](https://policy.ridi.com/legal/terms/v4.8)
- [리디 이용약관 (v4.7)](https://policy.ridi.com/legal/terms/v4.7)
- [리디 이용약관 (v4.6)](https://policy.ridi.com/legal/terms/v4.6)
- [리디 이용약관 (v4.5)](https://policy.ridi.com/legal/terms/v4.5)
- [리디 이용약관 (v4.4)](https://policy.ridi.com/legal/terms/v4.4)
- [리디 이용약관 (v4.3)](https://policy.ridi.com/legal/terms/v4.3)
- [리디 이용약관 (v4.2)](https://policy.ridi.com/legal/terms/v4.2)
- [리디 이용약관 (v4.1)](https://policy.ridi.com/legal/terms/v4.1)
- [리디 이용약관 (v3.4)](https://policy.ridi.com/legal/terms/v3.4)
