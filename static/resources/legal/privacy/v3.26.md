...
|:-------------------------------:|:-----------|:------------:|:--------------------:|:-------:|:----------------------------:|:----------:|
|             Zendesk             | 문의 및 안내 관리 | 아이디, 연락처, 이름 | 문의 등록 시에 네트워크를 통한 전송 |   미국    |     privacy@zendesk.com	     |  회원탈퇴시까지   |
...
- 개인정보처리방침 버전번호 : 3.26
- 개인정보처리방침 변경 공고일자 : 2023년 11월 16일
- 변경 개인정보처리방침 시행일자 : 2023년 11월 23일


[이전 개인정보 처리방침 보기]
- [리디북스 개인정보 처리방침 (v3.25)](https://policy.ridi.com/legal/privacy/v3.24)
