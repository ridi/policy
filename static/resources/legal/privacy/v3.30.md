...
| 서비스 이용과정에서 생성 및 수집되는 정보 | 결제 및 서비스 이용 기록 확인                                                                                                                                                       | (필수)<br/>서비스 이용기록, 방문기록, 불량 이용기록, 결제기록, IP주소, 쿠키, 브라우저 종류, <br/>모바일 기기정보(앱 버전, OS 버전, Device ID), ADID/IDFA(광고식별자) | 상동                                                                                    |
...
|:------------------:|:-----------|:------------:|:--------------------:|:-------:|:----------------------------:|:----------:|
|    Amplitude.Inc   | 이용 형태 분석, 서비스 개선 | 서비스 이용 기록,  디바이스 ID, 광고식별자, 성별, 출생년도 | 서비스 사용 시 네트워크를 통한 전송 |   미국    |    privacy@amplitude.com   |  회원탈퇴시까지   |
|     Freshworks     | 문의 및 안내 관리 | 아이디, 연락처, 이름 | 문의 등록 시에 네트워크를 통한 전송 |   미국    |     dpo@freshworks.com	     |  회원탈퇴시까지   |
|      Braze.Inc     | CRM, 맞춤형 정보 추천 서비스 제공, 푸시 알림 및 이메일 발송 | 서비스 이용 기록,  디바이스 ID, 광고식별자, 성별, 출생년도, 이메일 주소 | 서비스 사용 시 네트워크를 통한 전송 |   미국    |      privacy@braze.com	      |  회원탈퇴시까지   |
...
- 개인정보처리방침 버전번호 : 3.30
- 개인정보처리방침 변경 공고일자 : 2025년 5월 29일
- 변경 개인정보처리방침 시행일자 : 2025년 6월 5일
