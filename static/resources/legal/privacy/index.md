...
|:--------:|:-----------------------------------------------------:|:--------------------------------------------------:|:---------------------------------------------------:|
| (주)엔비티 | 이벤트 참여확인 및 중복 경품 제공 방지, 이벤트 추천 및 고객 문의 응대 | 사용자 해시 아이디, 생년월일, 성별, 광고식별자(ADID 또는 IDFA) | 사용자 해시 아이디, 생년월일, 성별, 광고식별자(ADID 또는 IDFA) |
...
현 개인정보처리방침 내용 추가, 삭제 및 수정이 있을 시에는 개정 최소 7일 전부터 홈페이지의 '공지사항'을 통해 고지할 것입니다. 또한 개인정보 보호정책에 버전번호 및 변경공고일자 및 그 시행일자 등을 부여하여 개정여부를 쉽게 알 수 있도록 하고 있습니다.
  ...
  - 개인정보처리방침 버전번호 : 3.21
  - 개인정보처리방침 변경 공고일자 : 2023년 3월 08일
  - 변경 개인정보처리방침 시행일자 : 2023년 3월 15일
